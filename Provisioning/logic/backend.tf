...
resource "azurerm_application_gateway" "azurerm_application_gateway" {
  name                = "${local.naming_convention}-aag"
...
resource "azurerm_linux_virtual_machine_scale_set" "azurerm_linux_virtual_machine_scale_set" {
  ...
  network_interface {
    ...
    ip_configuration {
      ...
      application_gateway_backend_address_pool_ids = "${azurerm_application_gateway.azurerm_application_gateway.backend_address_pool[*].id}"
    }
  }
}